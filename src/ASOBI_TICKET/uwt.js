!(function () {
  var t = {
          ...
          (function (t) {
            ...
            !(function () {
              ...
              for (var r = 2, i = 0; i < 64; )
                e(r) && (i < 8 && (c[i] = n(t.pow(r, 0.5))), (u[i] = n(t.pow(r, 1 / 3))), i++), r++;
            })();
            var s = [],
              l = (a.SHA256 = o.extend({
                _doReset: function () {
          ...
          return (function (t) {
            ...
            (function (t, e) {
              ...
              (function (t) {
                ...
                for (var e = 8 * t.length, n = new Uint32Array(m(e)), r = 0; r < e; r += 8)
      ...
      6527: function (t, e, n) {
        ...
        Object.defineProperty(e, "__esModule", { value: !0 }), (e.UWT = e.SET = e.OneTag = void 0);
        var a = o(n(6057)),
          c = o(n(510));
        e.OneTag = c;
        var u = o(n(3324));
      ...
      510: function (t, e, n) {
        ...
        Object.defineProperty(e, "__esModule", { value: !0 }), (e.set = e.event = e.config = void 0);
        var c = a(n(1952)),
          u = a(n(3257)),
          s = n(4654),
          l = a(n(1454)),
        ...
        e.config = function (t, e) {
          if ((void 0 === e && (e = {}), !t || "string" != typeof t))
            throw new Error(s.utilities.LogPrefix + ": Config is missing required Advertiser Id");
        ...
        e.event = function (t, e) {
          if ((void 0 === e && (e = {}), !t))
            throw new Error(s.utilities.LogPrefix + ": Event cannot send event without an Event Code Id");
          e = e && s.utilities.isObject(e) ? e : {};
          var n,
      ...
      3324: function (t, e, n) {
        ...
        Object.defineProperty(e, "__esModule", { value: !0 }), (e.trackPid = void 0);
        var c = a(n(1952)),
          u = a(n(3257)),
          s = n(4654);
      ...
      1454: function (t, e, n) {
        ...
        var f = function (t) {
          (e.defaultAccountParams = c = new u.AccountParams({ txn_id: t })), s.init(c);
        };
        e.setDefaultAccountParams = f;
        e.init = function (t) {
          if (!t || "string" != typeof t)
            throw new Error(l.utilities.LogPrefix + ": Init is missing required Pixel Id");
          f(t), u.globalParams.calledInit();
        };
        e.track = function (t, e) {
          if ((void 0 === e && (e = {}), !t || "string" != typeof t))
            throw new Error(l.utilities.LogPrefix + ": Track is missing required event name");
      ...
      1952: function (t, e, n) {
          ...
          return (
            ...
            (t.prototype.getPixelId = function () {
              var t,
                e,
                n =
                  (null === (t = this.paramKVs) || void 0 === t ? void 0 : t.txn_id) ||
                  (null === (e = this.paramKVs) || void 0 === e ? void 0 : e.merch_id);
        ...
        function v(t) {
          ...
          (t.tw_iframe_status = Number(e).toString()),
            e && "" !== document.referrer && (t.tw_document_referrer = document.referrer);
        }
        function y(t, e) {
      ...
      8352: function (t, e, n) {
        ...
        e.trackPid = function (t, e) {
          return (
            (e = r({ adsApiVersion: a.utilities.AdsApiVersion.v1, needResponse: !1 }, e)),
      ...
      3257: function (t, e, n) {
        ...
        Object.defineProperty(e, "__esModule", { value: !0 }), (e.track = e.init = void 0);
        var u = o(n(1952)),
          s = o(n(8352)),
          l = n(4654);
        (e.init = function (t) {
                ...
                switch (c.label) {
                  ...
                  case 1:
                    return (
                      ...
                      (t = !1),
                      e
                        ? (l.twclid.requestAccIfNeeded(e.getPixelId()), [4, l.twclid.getTwclidParams(e.getPixelId())])
                        : [3, 3]
                    );
                  case 2:
                  ...
                  case 3:
                    return (
                      ...
                      t && l.twclid.cacheAccRequestAndSaveTwclid(null == e ? void 0 : e.getPixelId(), a),
                      [2]
                    );
                }
              });
      ...
      2735: function (t, e, n) {
        ...
        (window.twttr = window.twttr || {}),
          window.twttr.conversion || ((window.twttr.conversion = i.default), n(2345));
      },
      6575: function (t, e, n) {
        "use strict";
        Object.defineProperty(e, "__esModule", { value: !0 }), (e.Cookies = void 0);
        var r = n(3532),
          i = (function () {
            function t() {}
            return (
              ...
              (t.convertCookieOptionsToString = function (t) {
                ...
                var e = "";
                for (var n in t)
                  r.hasOwnPropertyCi(t, n) && ("secure" === n && t[n] ? (e += ";" + n) : (e += ";" + n + "=" + t[n]));
      ...
      8974: function (t, e, n) {
        ...
        !(function (t) {
          ...
          (e.ACC_BASE = "https://ads-api.twitter.com/measurement/website_tag_settings?version=2.3.30"),
                    ...
                    case 2:
                      return (
                        ...
                        [
                          2,
                          !0 ===
                            (null === (r = null == e ? void 0 : e.data) || void 0 === r ? void 0 : r.allow_1p_cookie),
                        ]
                      );
                    case 3:
        ...
        e.getTwclid = function (t) {
          return r(void 0, void 0, void 0, function () {
            ...
            return i(this, function (r) {
              switch (r.label) {
                case 0:
                  return (n = e.getTwclidFromHref()) ? [2, { twclid: n, source: a.Href }] : [4, e.AccRequestCache[t]];
                case 1:
                  return r.sent() && (n = e.getTwclidFromCookie()) ? [2, { twclid: n, source: a.Cookie }] : [2];
              }
            });
          });
        };
      ...
      3532: function (t, e, n) {
        ...
        (e.getLegacyParams = function (t) {
          ...
          return (
            ...
            Array.isArray(c(t, "content_ids")) && (e.tw_product_id = c(t, "content_ids")[0]),
        ...
        e.getWildcardDomains = function () {
          for (var t = location.hostname.split("."), e = [], n = 2; n <= t.length; n++)
