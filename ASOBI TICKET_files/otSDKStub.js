    ...
    m =
      ...
      (h.prototype.setDomainDataFileURL = function () {
        ...
        t &&
          (p.isMigratedURL
            ...
            : (p.storageBaseURL = (e ? t.split("/consent") : t.split("/scripttemplates/" + p.stubFileName))[0])),
      ...
      (h.prototype.getParam = function () {
        ...
        var t = "true" === this.urlParams.get("otreset"),
          ...
          i =
            ((this.geoFromUrl = (this.urlParams.get("otgeo") || "").toLowerCase()), this.readCookieParam(r, "expiry")),
    ...
    (this.iabType = null),
      ...
      (this.addBannerSDKScript = function (t) {
        var e = s.getRegionSet(t),
          ...
          n = t.UseSDKRefactor
            ? (p.isMigratedURL &&
                (i.src = p.storageBaseURL + "/scripttemplates/new/scripttemplates/" + p.stubFileName + ".js"),
              p.storageBaseURL + "/scripttemplates/new/scripttemplates/" + t.Version + "/" + p.bannerScriptName)
            : "5.11.0" === t.Version
            ? (p.isMigratedURL &&
                (i.src = p.storageBaseURL + "/scripttemplates/old/scripttemplates/" + p.stubFileName + ".js"),
