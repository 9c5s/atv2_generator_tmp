import { a as zu, b as Ru, c as Iu, d as Lu, e as Ku, f as ju, g as Vu, h as S, i as Uu } from "./chunk-VX5M53MW.js";
import { a as Eu, b as Du, c as vu } from "./chunk-34BF27PS.js";
import "./chunk-MYYYE52V.js";
import "./chunk-CG3QYLSP.js";
import "./chunk-UA2D4DEK.js";
import "./chunk-OIZBS2D4.js";
import "./chunk-NYYTT32K.js";
import "./chunk-33REXPWD.js";
import "./chunk-JE5T4TJF.js";
import "./chunk-S6NGXUDE.js";
import "./chunk-QECU4MVA.js";
import "./chunk-IL2AAAVZ.js";
import { a as it, d as Fu, e as Bu, f as yu, g as Au } from "./chunk-FTRCDFLY.js";
import "./chunk-L7I645G2.js";
import { a as Su } from "./chunk-6KOVYJRY.js";
import "./chunk-DIBC6RKX.js";
import "./chunk-A4YNF7ZS.js";
import "./chunk-UDMLBNC2.js";
import "./chunk-SSR6LYXO.js";
import { c as Tu, d as ku, e as qe, f as st, g as qu, h as Ne } from "./chunk-GWPJTWTS.js";
import { a as wu, b as bu } from "./chunk-OZQRGKSP.js";
import "./chunk-VNL272AA.js";
import "./chunk-23EXG436.js";
import { a as _, b as Y, c as Ou, d as rt, e as Ee, f as ot, g as ke } from "./chunk-MNCVNH5C.js";
import { q as pu, t as hu, u as fu, y as Pu, z as Mu } from "./chunk-3OEM55JB.js";
import { a as Ce, b as _u, c as Nu } from "./chunk-W7G3I6BT.js";
import { a as ue } from "./chunk-PDXXYOMJ.js";
import "./chunk-LYBGWGG7.js";
import { a as xu } from "./chunk-YKBATHZN.js";
import {
  Bb as Zt,
  Ca as $t,
  Cb as Jt,
  ...
  yb as V,
  yc as du,
} from "./chunk-WUEKMFF4.js";
function $u(i, e) {
  return [
    { provide: Ce, useValue: i },
    { provide: Eu, useValue: e },
  ];
}
var Qu = (() => {
  let e = class e {
    constructor() {
      (this.bannedBreadcrumbUrls = [
        ...
        yu({
          ...
          integrations: [new Au.GlobalHandlers({ onerror: !1, onunhandledrejection: !1 })],
    ...
    extractError(u) {
      ...
      return typeof n == "string" || n instanceof Error
        ...
        ? n.status === 0 || n.status >= 400
          ...
          : n.message
        : n.message
        ? (Fu({ message: "Unknown error", data: n }), new Error(n.message))
...
function Hu() {
  return [he([wu.forRoot({ name: "__triad_db" })])];
}
function Yu(i, e, t) {
  return [he(fu, pu), gu({ basePath: "assets/icons" }), $u(i, e), Gu(t), Hu(), Wu, Cu(Su, { color: "basic-light" })];
}
var Xu = (() => {
  let e = class e {
    constructor() {
...
var Zu = (() => {
  let e = class e {
    constructor() {
      (this.triadService = O(Xu)), (this.ticketService = O(ju));
    }
    ngOnInit() {
...
function fn(i, e, t = new Map(), u = new Map()) {
  let n = [],
    r = [],
    s = -1,
    c = null;
    ...
    (e.forEach((m) => {
      ...
      m.forEach((A, y) => {
        let C = y,
          B = A;
        if (y !== "offset")
          switch (((C = i.normalizePropertyName(C, n)), B)) {
            case ke:
              B = t.get(y);
              break;
            case Y:
              ...
              break;
            default:
              B = i.normalizeStyleValue(y, C, B, n);
              break;
          }
        h.set(C, B);
      }),
...
var Di = typeof document > "u" ? null : document.documentElement;
function Ot(i) {
...
var se = null,
  un = !1;
function wi(i) {
  se || ((se = Si() || {}), (un = se.style ? "WebkitAppearance" in se.style : !1));
  let e = !0;
  return (
    se.style &&
      !vi(i) &&
      ((e = i in se.style), !e && un && (e = "Webkit" + i.charAt(0).toUpperCase() + i.slice(1) in se.style)),
    e
  );
}
function Si() {
...
function Ve(i, e, t) {
  return i.hasOwnProperty("duration") ? i : Mi(i, e, t);
}
function Mi(i, e, t) {
  ...
  if (typeof i == "string") {
    let c = i.match(u);
    if (c === null) return e.push(en(i)), { duration: 0, delay: 0, easing: "" };
    n = gt(parseFloat(c[1]), c[2]);
    let m = c[3];
    m != null && (r = gt(parseFloat(m), c[4]));
    let d = c[5];
    d && (s = d);
  } else n = i;
  if (!t) {
    let c = !1,
      m = e.length;
    n < 0 && (e.push(Gn()), (c = !0)), r < 0 && (e.push(Hn()), (c = !0)), c && e.splice(m, 0, en(i));
  }
...
function Ae(i) {
  return Array.isArray(i) ? (i.length == 1 ? i[0] : Ou(i)) : i;
}
function Ti(i, e, t) {
  let u = e.params || {},
    n = Bn(i);
  n.length &&
    n.forEach((r) => {
      u.hasOwnProperty(r) || t.push(Yn(r));
    });
}
var Ct = new RegExp(`${En}\\s*(.+?)\\s*${Pi}`, "g");
function Bn(i) {
  let e = [];
  if (typeof i == "string") {
    let t;
    for (; (t = Ct.exec(i)); ) e.push(t[1]);
    Ct.lastIndex = 0;
  }
  return e;
}
function xe(i, e, t) {
  let u = `${i}`,
    n = u.replace(Ct, (r, s) => {
      let c = e[s];
      return c == null && (t.push(Xn(s)), (c = "")), c.toString();
    });
  return n == u ? i : n;
}
var ki = /-+([a-z0-9])/g;
...
function Ri(i, e) {
  let t = [];
  return typeof i == "string" ? i.split(/\s*,\s*/).forEach((u) => Ii(u, t, e)) : t.push(i), t;
}
function Ii(i, e, t) {
  if (i[0] == ":") {
    let m = Li(i, t);
  ...
  if (u == null || u.length < 4) return t.push(mi(i)), e;
  let n = u[1],
    r = u[2],
    s = u[3];
  e.push(rn(n, s));
...
function rn(i, e) {
  ...
  return (n, r) => {
    ...
    return (
      ...
      !c && u && typeof r == "boolean" && (c = r ? Re.has(e) : Ie.has(e)),
      s && c
    );
  };
}
var yn = ":self",
  Ki = new RegExp(`s*${yn}s*,?`, "g");
function An(i, e, t, u) {
  return new Et(i).build(e, t, u);
}
var on = "",
  Et = class {
    constructor(e) {
    ...
    build(e, t, u) {
      let n = new Ft(t);
      return this._resetContextStyleTimingState(n), I(this, Ae(e), n);
    }
    _resetContextStyleTimingState(e) {
      (e.currentQuerySelector = on),
        (e.collectedStyles = new Map()),
        e.collectedStyles.set(on, new Map()),
        (e.currentTime = 0);
    }
    visitTrigger(e, t) {
      let u = (t.queryCount = 0),
        ...
        s = [];
      return (
        e.name.charAt(0) == "@" && t.errors.push(ei()),
        e.definitions.forEach((c) => {
          if ((this._resetContextStyleTimingState(t), c.type == _.State)) {
            let m = c,
              d = m.name;
            d
              .toString()
              ...
              (m.name = d);
          } else if (c.type == _.Transition) {
            let m = this.visitTransition(c, t);
            (u += m.queryCount), (n += m.depCount), s.push(m);
          } else t.errors.push(ti());
        }),
        { type: _.Trigger, name: e.name, states: r, transitions: s, queryCount: u, depCount: n, options: null }
      );
    }
    visitState(e, t) {
      ...
      if (u.containsDynamicStyles) {
        ...
        u.styles.forEach((c) => {
          ...
          r.size && t.errors.push(ui(e.name, [...r.values()]));
      }
      return { type: _.State, name: e.name, style: u, options: n ? { params: n } : null };
    }
    visitTransition(e, t) {
      (t.queryCount = 0), (t.depCount = 0);
      let u = I(this, Ae(e.animation), t),
        n = Ri(e.expr, t.errors);
      return {
        type: _.Transition,
        matchers: n,
        animation: u,
    ...
    visitSequence(e, t) {
      return { type: _.Sequence, steps: e.steps.map((u) => I(this, u, t)), options: ae(e.options) };
    }
    visitGroup(e, t) {
      let u = t.currentTime,
        n = 0,
        r = e.steps.map((s) => {
          t.currentTime = u;
          let c = I(this, s, t);
          return (n = Math.max(n, t.currentTime)), c;
        });
      return (t.currentTime = n), { type: _.Group, steps: r, options: ae(e.options) };
    }
    visitAnimate(e, t) {
      let u = $i(e.timings, t.errors);
      t.currentAnimateTimings = u;
      let n,
        r = e.styles ? e.styles : rt({});
      if (r.type == _.Keyframes) n = this.visitKeyframes(r, t);
      else {
        let s = e.styles,
          c = !1;
        if (!s) {
      ...
      return (t.currentAnimateTimings = null), { type: _.Animate, timings: u, style: n, options: null };
    }
    visitStyle(e, t) {
    ...
    _makeStyleAst(e, t) {
      ...
      for (let c of n)
        typeof c == "string" ? (c === Y ? u.push(c) : t.errors.push(ni(c))) : u.push(new Map(Object.entries(c)));
      let r = !1,
        s = null;
      return (
        u.forEach((c) => {
          if (c instanceof Map && (c.has("easing") && ((s = c.get("easing")), c.delete("easing")), !r)) {
            for (let m of c.values())
              if (m.toString().indexOf(En) >= 0) {
                r = !0;
                break;
              }
          }
        }),
        { type: _.Style, styles: u, easing: s, offset: e.offset, containsDynamicStyles: r, options: null }
      );
    }
            ...
            s.forEach((c, m) => {
              ...
              f &&
                (r != n &&
                  r >= f.startTime &&
                  n <= f.endTime &&
                  (t.errors.push(ii(m, f.startTime, f.endTime, r, n)), (h = !1)),
                (r = f.startTime)),
                h && d.set(m, { startTime: r, endTime: n }),
                t.options && Ti(c, t.options, t.errors);
            });
        });
    }
    visitKeyframes(e, t) {
      let u = { type: _.Keyframes, styles: [], options: null };
      if (!t.currentAnimateTimings) return t.errors.push(ri()), u;
      let n = 1,
        r = 0,
        s = [],
        c = !1,
        ...
        f = e.steps.map((b) => {
          let P = this._makeStyleAst(b, t),
            q = P.offset != null ? P.offset : Ui(P.styles),
            T = 0;
          return (
            q != null && (r++, (T = P.offset = q)), (m = m || T < 0 || T > 1), (c = c || T < d), (d = T), s.push(T), P
          );
        });
      m && t.errors.push(oi()), c && t.errors.push(si());
      let h = e.steps.length,
        A = 0;
      r > 0 && r < h ? t.errors.push(ai()) : r == 0 && (A = n / (h - 1));
      let y = h - 1,
        C = t.currentTime,
      ...
      return (
        f.forEach((b, P) => {
          let q = A > 0 ? (P == y ? 1 : A * P) : s[P],
            T = q * v;
          (t.currentTime = C + B.delay + T),
            (B.duration = T),
    ...
    visitReference(e, t) {
      return { type: _.Reference, animation: I(this, Ae(e.animation), t), options: ae(e.options) };
    }
    visitAnimateChild(e, t) {
      return t.depCount++, { type: _.AnimateChild, options: ae(e.options) };
    }
    visitAnimateRef(e, t) {
      return { type: _.AnimateRef, animation: this.visitReference(e.animation, t), options: ae(e.options) };
    }
    visitQuery(e, t) {
      let u = t.currentQuerySelector,
        n = e.options || {};
      t.queryCount++, (t.currentQuery = e);
      let [r, s] = ji(e.selector);
      (t.currentQuerySelector = u.length ? u + " " + r : r), L(t.collectedStyles, t.currentQuerySelector, new Map());
      let c = I(this, Ae(e.animation), t);
      return (
        (t.currentQuery = null),
    ...
    visitStagger(e, t) {
      ...
      let u = e.timings === "full" ? { duration: 0, delay: 0, easing: "full" } : Ve(e.timings, t.errors, !0);
      return { type: _.Stagger, animation: I(this, Ae(e.animation), t), timings: u, options: null };
    }
  };
function ji(i) {
  let e = !!i.split(/\s*,\s*/).find((t) => t == yn);
  return (
    e && (i = i.replace(Ki, "")),
    (i = i
      .replace(/@\*/g, je)
      .replace(/@\w+/g, (t) => je + "-" + t.slice(1))
...
function ae(i) {
  return i ? ((i = be({}, i)), i.params && (i.params = Vi(i.params))) : (i = {}), i;
}
function lt(i, e, t) {
  return { duration: i, delay: e, easing: t };
}
function Nt(i, e, t, u, n, r, s = null, c = !1) {
  return {
    type: 1,
    element: i,
    keyframes: e,
...
var De = class {
  ...
  Hi = ":leave",
  Yi = new RegExp(Hi, "g");
function _n(i, e, t, u, n, r = new Map(), s = new Map(), c, m, d = []) {
  return new Bt().buildKeyframes(i, e, t, u, n, r, s, c, m, d);
}
var Bt = class {
    buildKeyframes(e, t, u, n, r, s, c, m, d, f = []) {
      d = d || new De();
      let h = new yt(e, t, d, n, r, f, []);
      h.options = m;
      let A = m.delay ? J(m.delay) : 0;
      h.currentTimeline.delayNextStep(A), h.currentTimeline.setStyles([s], null, h.errors, m), I(this, u, h);
      let y = h.timelines.filter((C) => C.containsAnimation());
      if (y.length && c.size) {
        let C;
        ...
        C && !C.allowOnlyTimelineStyles() && C.setStyles([c], null, h.errors, m);
      }
      return y.length ? y.map((C) => C.buildKeyframes()) : [Nt(t, [], [], [], 0, A, "", !1)];
    }
    visitTrigger(e, t) {}
    visitState(e, t) {}
    visitTransition(e, t) {}
    ...
    _applyAnimationRefDelays(e, t, u) {
      for (let n of e) {
        let r = n?.delay;
        if (r) {
          let s = typeof r == "number" ? r : J(xe(r, n?.params ?? {}, t.errors));
          u.delayNextStep(s);
        }
      }
    }
    _visitSubInstructions(e, t, u) {
      let r = t.currentTimeline.currentTime,
        s = u.duration != null ? J(u.duration) : null,
        c = u.delay != null ? J(u.delay) : null;
      return (
        s !== 0 &&
          e.forEach((m) => {
            let d = t.appendInstructionToTimeline(m, s, c);
    ...
    visitReference(e, t) {
      t.updateOptions(e.options, !0), I(this, e.animation, t), (t.previousNode = e);
    }
    visitSequence(e, t) {
      ...
      if (r && (r.params || r.delay) && ((n = t.createSubContext(r)), n.transformIntoNewTimeline(), r.delay != null)) {
        n.previousNode.type == _.Style && (n.currentTimeline.snapshotCurrentStyles(), (n.previousNode = Qe));
        let s = J(r.delay);
        n.delayNextStep(s);
      }
      e.steps.length &&
        (e.steps.forEach((s) => I(this, s, n)),
    ...
    visitGroup(e, t) {
      let u = [],
        ...
        r = e.options && e.options.delay ? J(e.options.delay) : 0;
      e.steps.forEach((s) => {
        let c = t.createSubContext(e.options);
        r && c.delayNextStep(r),
          I(this, s, c),
          (n = Math.max(n, c.currentTimeline.currentTime)),
          u.push(c.currentTimeline);
      }),
    ...
    _visitTiming(e, t) {
      if (e.dynamic) {
        let u = e.strValue,
          n = t.params ? xe(u, t.params, t.errors) : u;
        return Ve(n, t.errors);
    ...
    visitKeyframes(e, t) {
      let u = t.currentAnimateTimings,
        ...
        r = u.duration,
        c = t.createSubContext().currentTimeline;
      (c.easing = u.easing),
        e.styles.forEach((m) => {
          let d = m.offset || 0;
          c.forwardTime(d * r), c.setStyles(m.styles, m.easing, t.errors, t.options), c.applyStylesToKeyframe();
        }),
    ...
    visitQuery(e, t) {
      let u = t.currentTimeline.currentTime,
        n = e.options || {},
        r = n.delay ? J(n.delay) : 0;
      r &&
        (t.previousNode.type === _.Style || (u == 0 && t.currentTimeline.hasCurrentStyleProperties())) &&
        (t.currentTimeline.snapshotCurrentStyles(), (t.previousNode = Qe));
      let s = u,
        c = t.invokeQuery(e.selector, e.originalSelector, e.limit, e.includeSelf, !!n.optional, t.errors);
      t.currentQueryTotal = c.length;
      let m = null;
      c.forEach((d, f) => {
        t.currentQueryIndex = f;
        let h = t.createSubContext(e.options, d);
        r && h.delayNextStep(r),
          d === t.element && (m = h.currentTimeline),
          I(this, e.animation, h),
          h.currentTimeline.applyStylesToKeyframe();
        let A = h.currentTimeline.currentTime;
        s = Math.max(s, A);
      }),
    ...
    visitStagger(e, t) {
      ...
      m && f.delayNextStep(m);
      let h = f.currentTime;
      I(this, e.animation, t),
        (t.previousNode = e),
        (u.currentStaggerTime = n.currentTime - h + (n.startTime - u.currentTimeline.startTime));
    }
  },
  Qe = {},
  yt = class i {
    constructor(e, t, u, n, r, s, c, m) {
      (this._driver = e),
        (this.element = t),
        ...
        (this.currentTimeline = m || new We(this._driver, t, 0)),
        c.push(this.currentTimeline);
    }
    get params() {
    ...
    updateOptions(e, t) {
      ...
      let u = e,
        n = this.options;
      u.duration != null && (n.duration = J(u.duration)), u.delay != null && (n.delay = J(u.delay));
      let r = u.params;
      if (r) {
        let s = n.params;
        s || (s = this.options.params = {}),
          Object.keys(r).forEach((c) => {
            (!t || !s.hasOwnProperty(c)) && (s[c] = xe(r[c], s, this.errors));
          });
      }
    }
    _copyOptions() {
    ...
    invokeQuery(e, t, u, n, r, s) {
      let c = [];
      if ((n && c.push(this.element), e.length > 0)) {
        (e = e.replace(Gi, "." + this._enterClassName)), (e = e.replace(Yi, "." + this._leaveClassName));
        let m = u != 1,
          d = this._driver.query(this.element, e, m);
        u !== 0 && (d = u < 0 ? d.slice(d.length + u, d.length) : d.slice(0, u)), c.push(...d);
      }
      return !r && c.length == 0 && s.push(ci(t)), c;
    }
  },
  We = class i {
    constructor(e, t, u, n) {
    ...
    forwardFrame() {
      (this.duration += Qi), this._loadKeyframe();
    }
    forwardTime(e) {
    ...
    setStyles(e, t, u, n) {
      ...
      let r = (n && n.params) || {},
        s = Xi(e, this._globalTimelineStyles);
      for (let [c, m] of s) {
        let d = xe(m, r, u);
        this._pendingStyles.set(c, d),
          this._localTimelineStyles.has(c) || this._backFill.set(c, this._globalTimelineStyles.get(c) ?? Y),
          this._updateStyle(c, d);
      }
    }
    ...
    buildKeyframes() {
      ...
      let e = new Set(),
        ...
        n = [];
      this._keyframes.forEach((c, m) => {
        let d = new Map([...this._backFill, ...c]);
        d.forEach((f, h) => {
          f === ke ? e.add(h) : f === Y && t.add(h);
        }),
      ...
      if (u) {
        let c = n[0],
          m = new Map(c);
        c.set("offset", 0), m.set("offset", 1), (n = [c, m]);
      }
      return Nt(this.element, n, r, s, this.duration, this.startTime, this.easing, !1);
    }
  },
  At = class extends We {
    constructor(e, t, u, n, r, s, c = !1) {
      super(e, t, s.delay),
        (this.keyframes = u),
        (this.preStyleProps = n),
        (this.postStyleProps = r),
        (this._stretchStartingKeyframe = c),
    ...
    buildKeyframes() {
      ...
      if (this._stretchStartingKeyframe && t) {
        ...
        let d = new Map(e[0]);
        d.set("offset", sn(c)), r.push(d);
        let f = e.length - 1;
        for (let h = 1; h <= f; h++) {
          let A = new Map(e[h]),
            y = A.get("offset"),
            C = t + y * u;
          A.set("offset", sn(C / s)), r.push(A);
        }
        (u = s), (t = 0), (n = ""), (e = r);
      }
      return Nt(this.element, e, this.preStyleProps, this.postStyleProps, u, t, n, !0);
    }
  };
function sn(i, e = 3) {
...
function an(i, e, t, u, n, r, s, c, m, d, f, h, A) {
  return {
    type: 0,
    element: i,
    triggerName: e,
...
var ct = {},
  Ge = class {
    ...
    match(e, t, u, n) {
      return Zi(this.ast.matchers, e, t, u, n);
    }
    buildStyles(e, t, u) {
      let n = this._stateStyles.get("*");
      return e !== void 0 && (n = this._stateStyles.get(e?.toString()) || n), n ? n.buildStyles(t, u) : new Map();
    }
    build(e, t, u, n, r, s, c, m, d, f) {
      let h = [],
        A = (this.ast.options && this.ast.options.params) || ct,
        y = (c && c.params) || ct,
        C = this.buildStyles(u, y, h),
        B = (m && m.params) || ct,
        v = this.buildStyles(n, B, h),
        b = new Set(),
        P = new Map(),
        q = new Map(),
        T = n === "void",
        de = { params: xn(B, A), delay: this.ast.options?.delay },
        W = f ? [] : _n(e, t, this.ast.animation, r, s, C, v, de, d, h),
        N = 0;
      return (
        W.forEach((z) => {
          N = Math.max(z.duration + z.delay, N);
        }),
        h.length
          ? an(t, this._triggerName, u, n, T, C, v, [], [], P, q, N, h)
          : (W.forEach((z) => {
              let ie = z.element,
                pe = L(P, ie, new Set());
              z.preStyleProps.forEach((re) => pe.add(re));
              let Rt = L(q, ie, new Set());
              z.postStyleProps.forEach((re) => Rt.add(re)), ie !== t && b.add(ie);
            }),
            an(t, this._triggerName, u, n, T, C, v, W, [...b.values()], P, q, N))
      );
    }
  };
function Zi(i, e, t, u, n) {
...
var _t = class {
  ...
  buildStyles(e, t) {
    let u = new Map(),
      n = xn(e, this.defaultParams);
    return (
      this.styles.styles.forEach((r) => {
        typeof r != "string" &&
          r.forEach((s, c) => {
            s && (s = xe(s, n, t));
            let m = this.normalizer.normalizePropertyName(c, t);
            (s = this.normalizer.normalizeStyleValue(c, m, s, t)), u.set(c, s);
          });
      }),
      u
    );
  ...
  constructor(e, t, u) {
    (this.name = e),
      ...
      t.states.forEach((n) => {
        ...
        this.states.set(n.name, new _t(n.style, r, u));
      }),
      ln(this.states, "true", "1"),
      ln(this.states, "false", "0"),
      t.transitions.forEach((n) => {
        this.transitionFactories.push(new Ge(e, n, this.states));
      }),
      (this.fallbackTransition = e0(e, this.states, this._normalizer));
  }
  get containsQueries() {
...
function e0(i, e, t) {
  let u = [(s, c) => !0],
    n = { type: _.Sequence, steps: [], options: null },
    r = { type: _.Transition, animation: n, matchers: u, options: null, queryCount: 0, depCount: 0 };
  return new Ge(i, r, e);
}
function ln(i, e, t) {
...
var t0 = new De(),
  Dt = class {
    ...
    register(e, t) {
      let u = [],
        n = [],
        r = An(this._driver, t, u, n);
      if (u.length) throw fi(u);
      n.length && void 0, this._animations.set(e, r);
    }
    _buildPlayer(e, t, u) {
      let n = e.element,
        r = fn(this._normalizer, e.keyframes, t, u);
    ...
    create(e, t, u = {}) {
      ...
      if (
        (r
          ? ((s = _n(this._driver, t, r, Fn, ht, new Map(), new Map(), u, t0, n)),
            s.forEach((f) => {
              let h = L(c, f.element, new Map());
              f.postStyleProps.forEach((A) => h.set(A, null));
            }))
          : (n.push(gi()), (s = [])),
        n.length)
      )
      ...
      c.forEach((f, h) => {
        f.forEach((A, y) => {
          f.set(y, this._driver.computeStyle(h, y, Y));
        });
      });
      let m = s.map((f) => {
          let h = c.get(f.element);
  ...
  cn = "ng-animate-queued",
  u0 = ".ng-animate-queued",
  mt = "ng-animate-disabled",
  n0 = ".ng-animate-disabled",
  i0 = "ng-star-inserted",
  r0 = ".ng-star-inserted",
  o0 = [],
  Dn = { namespaceId: "", setForRemoval: !1, setForMove: !1, hasAnimation: !1, removedBeforeQueried: !1 },
  s0 = { namespaceId: "", setForMove: !1, setForRemoval: !1, hasAnimation: !1, removedBeforeQueried: !0 },
  Q = "__ng_removed",
  ve = class {
    get params() {
      return this.options.params;
  ...
  vt = class {
    ...
    listen(e, t, u, n) {
      if (!this._triggers.has(t)) throw Fi(u, t);
      if (u == null || u.length == 0) throw Bi(t);
      if (!c0(u)) throw yi(u, t);
      let r = L(this._elementListeners, e, []),
        s = { name: t, phase: u, callback: n };
      r.push(s);
      let c = L(this._engine.statesByElement, e, new Map());
      return (
        c.has(t) || (U(e, ze), U(e, ze + "-" + t), c.set(t, dt)),
        () => {
          this._engine.afterFlush(() => {
            let m = r.indexOf(s);
            m >= 0 && r.splice(m, 1), this._triggers.has(t) || c.delete(t);
          });
        }
      );
    }
    ...
    trigger(e, t, u, n = !0) {
      let r = this._getTrigger(t),
        s = new we(this.id, t, e),
        c = this._engine.statesByElement.get(e);
      c || (U(e, ze), U(e, ze + "-" + t), this._engine.statesByElement.set(e, (c = new Map())));
      let m = c.get(t),
        d = new ve(u, this.id);
      if (
        ...
        c.set(t, d),
        m || (m = dt),
        !(d.value === _e) && m.value === d.value)
      ) {
        if (!p0(m.params, d.params)) {
          let B = [],
            v = r.matchStyles(m.value, m.params, B),
            b = r.matchStyles(d.value, d.params, B);
          B.length
    ...
    _signalRemovalForInnerTriggers(e, t) {
      let u = this._engine.driver.query(e, je, !0);
      u.forEach((n) => {
        if (n[Q]) return;
      ...
      if (r) {
        ...
        if (
          ...
          return (
            ...
            u && ne(c).onDone(() => this._engine.processLeaveNode(e)),
            !0
          );
      }
      return !1;
    ...
    drainQueuedTransitions(e) {
      ...
      return (
        this._queue.forEach((u) => {
          ...
          s &&
            s.forEach((c) => {
              if (c.name == u.triggerName) {
                let m = Mt(r, u.triggerName, u.fromState.value, u.toState.value);
                (m._data = e), Pt(u.player, c.phase, m, c.callback);
              }
            }),
            n.markedForDestroy
              ? this._engine.afterFlush(() => {
  ...
  wt = class {
    ...
    _balanceNamespaceList(e, t) {
      ...
      if (u.length - 1 >= 0) {
        let s = !1,
          c = this.driver.getParentElement(t);
        for (; c; ) {
          let m = n.get(c);
          if (m) {
            let d = u.indexOf(m);
          ...
          c = this.driver.getParentElement(c);
        }
        s || u.unshift(e);
      } else u.push(e);
      return n.set(t, e), e;
    ...
    markElementAsDisabled(e, t) {
      t
        ? this.disabledNodes.has(e) || (this.disabledNodes.add(e), U(e, mt))
    ...
    listen(e, t, u, n, r) {
      return Le(t) ? this._fetchNamespace(e).listen(t, u, n, r) : () => {};
    }
    ...
    destroyInnerAnimations(e) {
      let t = this.driver.query(e, je, !0);
    ...
    whenRenderingDone() {
      return new Promise((e) => {
        if (this.players.length) return ne(this.players).onDone(() => e());
        e();
      });
    }
    processLeaveNode(e) {
      ...
      e.classList?.contains(mt) && this.markElementAsDisabled(e, !1),
        this.driver.query(e, n0, !0).forEach((u) => {
    ...
    _flushAnimations(e, t) {
      ...
      this.disabledNodes.forEach((g) => {
        f.add(g);
        let E = this.driver.query(g, u0, !0);
        for (let F = 0; F < E.length; F++) f.add(E[F]);
      });
      let h = this.bodyNode,
        A = Array.from(this.statesByElement.keys()),
        y = pn(A, this.collectedEnterElements),
        C = new Map(),
        B = 0;
      y.forEach((g, E) => {
        let F = Fn + B++;
        C.set(E, F), g.forEach((x) => U(x, F));
      });
      let v = [],
        b = new Set(),
        P = new Set();
      for (let g = 0; g < this.collectedLeaveElements.length; g++) {
        let E = this.collectedLeaveElements[g],
          F = E[Q];
        F &&
          F.setForRemoval &&
          (v.push(E), b.add(E), F.hasAnimation ? this.driver.query(E, r0, !0).forEach((x) => b.add(x)) : P.add(E));
      }
      let q = new Map(),
        T = pn(A, Array.from(b));
      T.forEach((g, E) => {
        let F = ht + B++;
        q.set(E, F), g.forEach((x) => U(x, F));
      }),
        e.push(() => {
          y.forEach((g, E) => {
            let F = C.get(E);
      ...
      for (let g = this._namespaceList.length - 1; g >= 0; g--)
        this._namespaceList[g].drainQueuedTransitions(t).forEach((F) => {
          let x = F.player,
            M = F.element;
          if ((de.push(x), this.collectedEnterElements.length)) {
            let k = M[Q];
            if (k && k.setForMove) {
              if (k.previousTriggersValues && k.previousTriggersValues.has(F.triggerName)) {
                let oe = k.previousTriggersValues.get(F.triggerName),
                  K = this.statesByElement.get(F.element);
                if (K && K.has(F.triggerName)) {
                  let Se = K.get(F.triggerName);
                  (Se.value = oe), K.set(F.triggerName, Se);
                }
              }
              x.destroy();
              return;
          ...
          let G = !h || !this.driver.containsElement(h, M),
            R = q.get(M),
            ee = C.get(M),
            w = this._buildInstruction(F, u, ee, R, G);
          if (w.errors && w.errors.length) {
            W.push(w);
            return;
          }
          if (G) {
            x.onStart(() => le(M, w.fromStyles)), x.onDestroy(() => Z(M, w.toStyles)), n.push(x);
            return;
          }
          ...
          let Kt = [];
          w.timelines.forEach((k) => {
            (k.stretchStartingKeyframe = !0), this.disabledNodes.has(k.element) || Kt.push(k);
          }),
            (w.timelines = Kt),
            u.append(M, w.timelines);
          let Qn = { instruction: w, player: x, element: M };
          s.push(Qn),
            w.queriedElements.forEach((k) => L(c, k, []).push(x)),
            w.preStyleProps.forEach((k, oe) => {
              if (k.size) {
                let K = m.get(oe);
                K || m.set(oe, (K = new Set())), k.forEach((Se, et) => K.add(et));
              }
            }),
            w.postStyleProps.forEach((k, oe) => {
              let K = d.get(oe);
              K || d.set(oe, (K = new Set())), k.forEach((Se, et) => K.add(et));
            });
        });
      if (W.length) {
        let g = [];
        W.forEach((E) => {
          g.push(xi(E.triggerName, E.errors));
        }),
          de.forEach((E) => E.destroy()),
          this.reportError(g);
      }
      let N = new Map(),
        z = new Map();
      s.forEach((g) => {
        let E = g.element;
        u.has(E) && (z.set(E, E), this._beforeAnimationBuild(g.player.namespaceId, g.instruction, N));
      }),
        n.forEach((g) => {
          let E = g.element;
          this._getPreviousPlayers(E, !1, g.namespaceId, g.triggerName, null).forEach((x) => {
            L(N, E, []).push(x), x.destroy();
          });
        });
      let ie = v.filter((g) => hn(g, m, d)),
        pe = new Map();
      dn(pe, this.driver, P, d, Y).forEach((g) => {
        hn(g, m, d) && ie.push(g);
      });
      let re = new Map();
      y.forEach((g, E) => {
        dn(re, this.driver, new Set(g), m, ke);
      }),
        ie.forEach((g) => {
          let E = pe.get(g),
            F = re.get(g);
          pe.set(g, new Map([...(E?.entries() ?? []), ...(F?.entries() ?? [])]));
        });
      let Je = [],
        It = [],
        Lt = {};
      s.forEach((g) => {
        let { element: E, player: F, instruction: x } = g;
        if (u.has(E)) {
          if (f.has(E)) {
            F.onDestroy(() => Z(E, x.toStyles)), (F.disabled = !0), F.overrideTotalTime(x.totalTime), n.push(F);
            return;
          }
          let M = Lt;
          if (z.size > 1) {
            ...
            ee.forEach((w) => z.set(w, M));
          }
          let G = this._buildAnimation(F.namespaceId, x, N, r, re, pe);
          if ((F.setRealPlayer(G), M === Lt)) Je.push(F);
          else {
            let R = this.playersByElement.get(M);
            R && R.length && (F.parentPlayer = ne(R)), n.push(F);
          }
        } else le(E, x.fromStyles), F.onDestroy(() => Z(E, x.toStyles)), It.push(F), f.has(E) && n.push(F);
      }),
        It.forEach((g) => {
          let E = r.get(g.element);
          if (E && E.length) {
            let F = ne(E);
            g.setRealPlayer(F);
          }
      ...
      for (let g = 0; g < v.length; g++) {
        let E = v[g],
          F = E[Q];
        if ((Fe(E, ht), F && F.hasAnimation)) continue;
        let x = [];
        if (c.size) {
          let G = c.get(E);
          G && G.length && x.push(...G);
          let R = this.driver.query(E, ft, !0);
          for (let ee = 0; ee < R.length; ee++) {
            let w = c.get(R[ee]);
            w && w.length && x.push(...w);
          }
        }
        let M = x.filter((G) => !G.destroyed);
        M.length ? m0(this, E, M) : this.processLeaveNode(E);
      }
      return (
        (v.length = 0),
        Je.forEach((g) => {
    ...
    _getPreviousPlayers(e, t, u, n, r) {
      let s = [];
      if (t) {
        let c = this.playersByQueriedElement.get(e);
        c && (s = c);
      } else {
        let c = this.playersByElement.get(e);
        if (c) {
          let m = !r || r == _e;
          c.forEach((d) => {
      ...
      return (u || n) && (s = s.filter((c) => !((u && u != c.namespaceId) || (n && n != c.triggerName)))), s;
    }
    _beforeAnimationBuild(e, t, u) {
      let n = t.triggerName,
        r = t.element,
        s = t.isRemovalTransition ? void 0 : e,
        c = t.isRemovalTransition ? void 0 : n;
      for (let m of t.timelines) {
        let d = m.element,
          f = d !== r,
          h = L(u, d, []);
        this._getPreviousPlayers(d, f, s, c, t.toState).forEach((y) => {
          let C = y.getRealPlayer();
          C.beforeDestroy && C.beforeDestroy(), y.destroy(), h.push(y);
        });
      }
      le(r, t.fromStyles);
    }
    _buildAnimation(e, t, u, n, r, s) {
      let c = t.triggerName,
        ...
        A = t.timelines.map((C) => {
          ...
          f.add(B);
          let v = B[Q];
          if (v && v.removedBeforeQueried) return new Ee(C.duration, C.delay);
          let b = B !== m,
            P = d0((u.get(B) || o0).map((N) => N.getRealPlayer())).filter((N) => {
              let z = N;
              return z.element ? z.element === B : !1;
            }),
            q = r.get(B),
            T = s.get(B),
            de = fn(this._normalizer, C.keyframes, q, T),
            W = this._buildPlayer(C, de, P);
          if ((C.subTimeline && n && h.add(B), b)) {
            let N = new we(e, c, B);
            N.setRealPlayer(W), d.push(N);
          }
          return W;
        });
      d.forEach((C) => {
        L(this.playersByQueriedElement, C.element, []).push(C),
          C.onDone(() => a0(this.playersByQueriedElement, C.element, C));
      }),
        f.forEach((C) => U(C, nn));
      let y = ne(A);
      return (
        y.onDestroy(() => {
          f.forEach((C) => Fe(C, nn)), Z(m, t.toStyles);
        }),
        h.forEach((C) => {
          L(n, C, []).push(y);
        }),
...
function dn(i, e, t, u, n) {
  let r = [];
  t.forEach((m) => r.push(mn(m)));
  let s = [];
  u.forEach((m, d) => {
    let f = new Map();
    m.forEach((h) => {
      let A = e.computeStyle(d, h, n);
      f.set(h, A), (!A || A.length == 0) && ((d[Q] = s0), s.push(d));
    }),
      i.set(d, f);
  });
  let c = 0;
  return t.forEach((m) => mn(m, r[c++])), s;
}
function pn(i, e) {
  let t = new Map();
  if ((i.forEach((c) => t.set(c, [])), e.length == 0)) return t;
  let u = 1,
    n = new Set(e),
    r = new Map();
  function s(c) {
    ...
    if (m) return m;
    let d = c.parentNode;
    return t.has(d) ? (m = d) : n.has(d) ? (m = u) : (m = s(d)), r.set(c, m), m;
  }
  return (
    e.forEach((c) => {
      let m = s(c);
...
function m0(i, e, t) {
  ne(t).onDone(() => i.processLeaveNode(e));
}
function d0(i) {
  let e = [];
  return vn(i, e), e;
...
function vn(i, e) {
  for (let t = 0; t < i.length; t++) {
    let u = i[t];
    u instanceof ot ? vn(u.players, e) : e.push(u);
  }
}
function p0(i, e) {
  let t = Object.keys(i),
...
var ye = class {
  constructor(e, t, u) {
    (this._driver = t),
      ...
      (this._triggerCache = {}),
      (this.onRemovalComplete = (n, r) => {}),
      (this._transitionEngine = new wt(e.body, t, u)),
      (this._timelineEngine = new Dt(e.body, t, u)),
      (this._transitionEngine.onRemovalComplete = (n, r) => this.onRemovalComplete(n, r));
  }
  registerTrigger(e, t, u, n, r) {
    let s = e + "-" + n,
      c = this._triggerCache[s];
    if (!c) {
      let m = [],
        d = [],
        f = An(this._driver, r, m, d);
      if (m.length) throw pi(n, m);
      d.length && void 0, (c = Ji(n, f, this._normalizer)), (this._triggerCache[s] = c);
    }
    this._transitionEngine.registerTrigger(t, n, c);
  }
  register(e, t) {
  ...
  process(e, t, u, n) {
    if (u.charAt(0) == "@") {
      let [r, s] = tn(u),
        c = n;
      this._timelineEngine.command(r, t, s, c);
    } else this._transitionEngine.trigger(e, t, u, n);
  }
  listen(e, t, u, n, r) {
    if (u.charAt(0) == "@") {
      let [s, c] = tn(u);
      return this._timelineEngine.listen(s, t, c, r);
    }
...
function h0(i, e) {
  ...
  return (
    Array.isArray(e) && e.length
      ? ((t = pt(e[0])), e.length > 1 && (u = pt(e[e.length - 1])))
      : e instanceof Map && (t = pt(e)),
    t || u ? new St(i, t, u) : null
  );
}
var Be = class Be {
  constructor(e, t, u) {
  ...
  destroy() {
    this.finish(),
      this._state < 3 &&
        ...
        this._startStyles && (le(this._element, this._startStyles), (this._endStyles = null)),
        this._endStyles && (le(this._element, this._endStyles), (this._endStyles = null)),
        Z(this._element, this._initialStyles),
        (this._state = 3));
  }
};
...
var He = class {
    ...
    beforeDestroy() {
      ...
      this.hasStarted() &&
        this._finalKeyframe.forEach((u, n) => {
          n !== "offset" && e.set(n, this._finished ? u : qt(this.element, n));
        }),
  ...
  Ye = class {
    ...
    animate(e, t, u, n, r, s = []) {
      let c = n == 0 ? "both" : "forwards",
        m = { duration: u, delay: n, fill: c };
      r && (m.easing = r);
      let d = new Map(),
        f = s.filter((y) => y instanceof He);
      qi(u, n) &&
        f.forEach((y) => {
          y.currentSnapshot.forEach((C, B) => d.set(B, C));
        });
      let h = Oi(t).map((y) => new Map(y));
      h = Ni(e, h, d);
      let A = h0(e, h);
      return new He(e, h, m, A);
    }
  };
var Ke = "@",
  wn = "@.disabled",
  Xe = class {
    ...
    setProperty(e, t, u) {
      t.charAt(0) == Ke && t == wn ? this.disableAnimations(e, !!u) : this.delegate.setProperty(e, t, u);
    }
    setValue(e, t) {
    ...
    listen(e, t, u) {
      if (t.charAt(0) == Ke) {
        let n = g0(e),
          ...
          s = "";
        return (
          r.charAt(0) != Ke && ([r, s] = C0(r)),
          this.engine.listen(this.namespaceId, n, r, s, (c) => {
            let m = c._data || -1;
            this.factory.scheduleListenerCallback(m, u, c);
          })
        );
      }
      return this.delegate.listen(e, t, u);
...
var Ze = class {
  ...
  createRenderer(e, t) {
    ...
    if (!e || !t?.data?.animation) {
      ...
      if (!f) {
        let h = () => d.delete(n);
        (f = new Xe(u, n, this.engine, h)), d.set(n, f);
      }
      return f;
    }
    let r = t.id,
    ...
    let c = (d) => {
      Array.isArray(d) ? d.forEach(c) : this.engine.registerTrigger(r, s, e, d.name, d);
    };
    return t.data.animation.forEach(c), new bt(this, s, n, this.engine);
  }
  begin() {
...
var F0 = (() => {
  ...
  (e.ɵfac = function (n) {
    return new (n || e)(Pe(tu), Pe(ce), Pe(me));
  }),
    (e.ɵprov = H({ token: e, factory: e.ɵfac }));
  let i = e;
  return i;
...
var Sn = [
    { provide: me, useFactory: B0 },
    { provide: ye, useClass: F0 },
    { provide: $t, useFactory: y0, deps: [ou, ye, Oe] },
  ],
  A0 = [{ provide: ce, useFactory: () => new Ye() }, { provide: tt, useValue: "BrowserAnimations" }, ...Sn],
  Dr = [{ provide: ce, useClass: Tt }, { provide: tt, useValue: "NoopAnimations" }, ...Sn];
function bn() {
  return Qt("NgEagerAnimations"), [...A0];
}
var Pn = (() => {
    ...
    (e.ɵcmp = j({
      ...
      template: function (n, r) {
        n & 1 &&
          ...
          o(9, "\u30D0\u30F3\u30C0\u30A4\u30CA\u30E0\u30B3ID \u3067\u30ED\u30B0\u30A4\u30F3"),
          l(),
          a(10, "div", 4)(11, "button", 5),
          $("click", function () {
            return r.signIn();
          }),
          o(12, " \u30ED\u30B0\u30A4\u30F3\u30FB\u65B0\u898F\u767B\u9332 "),
          l()()()()),
          n & 2 && (Ut(2), Xt(r.headerText));
      },
      dependencies: [te, Pu, Mu, ue],
      styles: [
...
var Mn = (() => {
  let e = class e extends qe {
    constructor() {
      super(...arguments), (this._dialog = O(hu));
    }
    openAuthModal({ returnPath: u, headerText: n } = {}) {
      return this._dialog.open(Pn, { maxWidth: "580px", width: "95%", data: { returnPath: u, headerText: n } });
    }
  };
  (e.ɵfac = (() => {
    let u;
      ...
      template: function (n, r) {
        if (n & 1) {
          ...
          a(0, "section", 2)(1, "h2", 3),
            ...
            a(16, "a", 10),
            $("click", function () {
              return fe(s), ge(r.signUp());
            }),
            o(17, "\u30A2\u30AB\u30A6\u30F3\u30C8\u767B\u9332\u306F\u3053\u3061\u3089"),
            l()()()(),
            a(18, "section", 2)(19, "h2", 3),
            o(20, "\u4E8B\u524D\u540C\u884C\u8005\u767B\u9332\u306E\u6D41\u308C"),
            l(),
            a(21, "div", 11)(22, "div", 12)(23, "a", 13),
            $("click", function () {
              fe(s);
              let m = ut(39);
              return ge(r.scrollToElement(m));
            }),
            a(24, "div", 14),
            o(25, "STEP 01"),
            l(),
            ...
            o(37, "\u540C\u884C\u8005\u3092\u9078\u629E\u3059\u308B"),
            l()()(),
            a(38, "div", 17, 0)(40, "h3", 18)(41, "div", 19),
            o(42, "STEP 01"),
            l(),
            a(43, "div", 20),
            o(44, "\u540C\u884C\u8005\u3092\u30EA\u30B9\u30C8\u306B\u8FFD\u52A0\u3059\u308B"),
            ...
            o(51, "\u540C\u884C\u8005\u4E00\u89A7\u306B\u8FFD\u52A0\u3055\u308C\u307E\u3059\u3002 "),
            l(),
            a(52, "div", 22)(53, "h4", 23),
            o(54, "\u7533\u8FBC\u8005\u5074\u306E\u64CD\u4F5C"),
            l(),
            a(55, "div", 24)(56, "div", 25),
            o(57, "\u53F3\u4E0A\u306E\u30E1\u30CB\u30E5\u30FC\u3092\u30BF\u30C3\u30D7"),
            l(),
            p(58, "img", 26),
            l(),
            a(59, "div", 24)(60, "div", 25),
            ...
            l()(),
            a(65, "div", 24)(66, "div", 25),
            o(67, "\u30DE\u30A4\u30DA\u30FC\u30B8\u3067\u540C\u884C\u8005\u8A2D\u5B9A\u3092\u30BF\u30C3\u30D7"),
            l(),
            p(68, "img", 29),
            l(),
            a(69, "div", 24)(70, "div", 25),
            o(71, "\u540C\u884C\u8005\u3092\u8FFD\u52A0\u3059\u308B\u3092\u30BF\u30C3\u30D7"),
            l(),
            p(72, "img", 30),
            l(),
            a(73, "div", 24)(74, "div", 25),
            o(
              75,
            ...
            p(76, "img", 31),
            l()(),
            a(77, "div", 22)(78, "h4", 23),
            o(79, "\u540C\u884C\u8005\u5074\u306E\u64CD\u4F5C"),
            l(),
            a(80, "div", 24)(81, "div", 25),
            o(
              82,
            ...
            l()(),
            a(86, "div", 24)(87, "div", 25),
            o(88, "\u7533\u8FBC\u8005\u306E\u540D\u524D\u3092\u78BA\u8A8D\u3057\u3066\u62DB\u5F85\u3092\u627F\u8A8D"),
            l(),
            p(89, "img", 33),
            l(),
            a(90, "div", 24)(91, "div", 25),
            o(92, "\u540C\u884C\u8005\u4E00\u89A7\u306B\u8FFD\u52A0\u3055\u308C\u307E\u3059"),
            l(),
            p(93, "img", 34),
            a(94, "div", 28),
            ...
            l()()()(),
            a(96, "div", 17, 1)(98, "h3", 18)(99, "div", 19),
            o(100, "STEP 02"),
            l(),
            a(101, "div", 20),
            ...
            l(),
            a(105, "div", 22)(106, "h4", 23),
            o(107, "\u30C1\u30B1\u30C3\u30C8\u7533\u8FBC\u753B\u9762"),
            l(),
            a(108, "div", 24)(109, "div", 25),
            o(110, "\u30BF\u30C3\u30D7\u3057\u3066\u540C\u884C\u8005\u4E00\u89A7\u3092\u958B\u304F"),
            l(),
            p(111, "img", 35),
            l(),
            a(112, "div", 24)(113, "div", 25),
            o(
              114,
              "\u4E8B\u524D\u306B\u767B\u9332\u3055\u308C\u305F\u4E00\u89A7\u304B\u3089\u540C\u884C\u8005\u3092\u9078\u629E"
            ),
            ...
            p(115, "img", 36),
            l(),
            a(116, "div", 24)(117, "div", 25),
            o(118, "\u540C\u884C\u8005\u3068\u3057\u3066\u8A2D\u5B9A\u3059\u308B\u3092\u30BF\u30C3\u30D7"),
            l(),
            p(119, "img", 37),
            l(),
            a(120, "div", 24)(121, "div", 25),
            o(
              122,
            ...
            p(123, "img", 38),
            l()()()()(),
            a(124, "section", 2)(125, "h2", 3),
            o(126, "\u3088\u304F\u3042\u308B\u3054\u8CEA\u554F"),
            l(),
            a(127, "div", 39)(128, "div", 40),
            p(129, "input", 41),
            a(130, "label", 42)(131, "div", 43),
            o(
              132,
              "\u7533\u8FBC\u8005\u81EA\u8EAB\u3092\u540C\u884C\u8005\u306B\u3059\u308B\u3053\u3068\u306F\u3067\u304D\u307E\u3059\u304B\uFF1F"
            ),
            l()(),
            a(133, "div", 44)(134, "div", 45),
            o(135, "\u3067\u304D\u307E\u305B\u3093\u3002"),
            l()()(),
            a(136, "div", 40),
            p(137, "input", 46),
            a(138, "label", 47)(139, "div", 43),
            o(
              140,
              "\u8907\u6570\u4EBA\u3067\u53C2\u52A0\u3057\u305F\u3044\u5834\u5408\u3001\u304A\u4E92\u3044\u3092\u540C\u884C\u8005\u3068\u3057\u3066\u7533\u8FBC\u307F\u3067\u304D\u307E\u3059\u304B\uFF1F"
            ),
            l()(),
            a(141, "div", 44)(142, "div", 45)(143, "div", 48),
            o(
              144,
            ...
            a(147, "div", 40),
            p(148, "input", 50),
            a(149, "label", 51)(150, "div", 43),
            o(
              151,
              " \u7533\u8FBC\u8005\u3068\u3057\u3066\u30C1\u30B1\u30C3\u30C8\u3092\u8CFC\u5165\u3057\u3066\u3044\u308B\u5834\u5408\u3001\u4ED6\u306E\u65B9\u304C\u7533\u8FBC\u307F\u3057\u305F\u30C1\u30B1\u30C3\u30C8\u306E\u540C\u884C\u8005\u3068\u3057\u3066\u767B\u9332\u3067\u304D\u307E\u3059\u304B\uFF1F "
            ),
            l()(),
            a(152, "div", 44)(153, "div", 45),
            o(
              154,
            ...
            a(155, "div", 40),
            p(156, "input", 52),
            a(157, "label", 53)(158, "div", 43),
            o(
              159,
              "\u7533\u8FBC\u307F\u3057\u305F\u516C\u6F14\u306B\u540C\u884C\u8005\u767B\u9332\u304C\u3067\u304D\u3066\u3044\u308B\u304B\u78BA\u8A8D\u3057\u305F\u3044\u3067\u3059\u3002"
            ),
            l()(),
            a(160, "div", 44)(161, "div", 45),
            o(
              162,
            ...
            a(165, "div", 40),
            p(166, "input", 54),
            a(167, "label", 55)(168, "div", 43),
            o(
              169,
              " \u540C\u884C\u8005\u767B\u9332\u5F8C\u306B\u540C\u884C\u8005\u306E\u5909\u66F4\u306F\u3067\u304D\u307E\u3059\u304B\uFF1F\u307E\u305F\u3001\u540C\u884C\u8005\u3092\u5909\u66F4\u3057\u305F\u5F8C\u306B\u3001\u518D\u5EA6\u5909\u66F4\u3067\u304D\u307E\u3059\u304B\uFF1F "
            ),
            l()(),
            a(170, "div", 44)(171, "div", 45)(172, "div", 48),
            o(
              173,
...
`
          ...
          l(),
          a(4, "section", 1)(5, "div", 2)(6, "div", 3)(7, "p"),
          o(
            8,
          ...
          l()()()()(),
          a(95, "div", 16)(96, "h3", 17)(97, "div", 18),
          o(98, "STEP 01"),
          l()(),
          a(99, "div", 19)(100, "h4", 20),
          o(101, "\u51FA\u54C1\u3059\u308B"),
          l(),
          a(102, "ol", 21)(103, "li")(104, "a", 22),
          o(105, "\u30C1\u30B1\u30C3\u30C8\u7533\u8FBC\u5C65\u6B74"),
          l(),
          o(
            106,
          ...
          o(140, "\u300D\u30DA\u30FC\u30B8\u3067\u3082\u3054\u78BA\u8A8D\u304F\u3060\u3055\u3044\u3002 "),
          l()()()(),
          a(141, "div", 16)(142, "h3", 17)(143, "div", 18),
          o(144, "STEP 02"),
          l()(),
          a(145, "div", 19)(146, "h4", 20),
          o(147, "\u30EA\u30BB\u30FC\u30EB\u6210\u7ACB\u306E\u78BA\u8A8D"),
          l(),
          a(148, "ul", 23)(149, "li"),
          o(
          ...
          l()()()(),
          a(164, "div", 16)(165, "h3", 17)(166, "div", 18),
          o(167, "STEP 03"),
          l()(),
          a(168, "div", 19)(169, "h4", 20),
          o(170, "\u8FD4\u91D1\u624B\u7D9A\u304D"),
          l(),
          a(171, "ul", 15)(172, "li"),
          o(
          ...
          l()()()()(),
          a(233, "section", 1)(234, "h2", 5),
          o(235, "\u7533\u8FBC\u8005\u306E\u6D41\u308C"),
          l(),
          a(236, "div", 6)(237, "div", 7),
          o(238, "\u3010\u30C1\u30B1\u30C3\u30C8\u6599\u91D1\u3011"),
          l(),
          a(239, "div", 8)(240, "p"),
          o(241, " \u30A4\u30D9\u30F3\u30C8\u306B\u3088\u308A\u7570\u306A\u308A\u307E\u3059\u3002"),
          ...
          l()()(),
          a(244, "div", 6)(245, "div", 7),
          o(246, "\u3010\u624B\u6570\u6599\u3011"),
          l(),
          a(247, "div", 8)(248, "p", 25),
          o(
            249,
            " \u30C1\u30B1\u30C3\u30C8\u6599\u91D1\u3068\u306F\u5225\u3067\u624B\u6570\u6599\u304C\u767A\u751F\u3057\u307E\u3059\u3002"
          ),
          ...
          l()()(),
          a(252, "div", 16)(253, "h3", 17)(254, "div", 18),
          o(255, "STEP 01"),
          l()(),
          a(256, "div", 19)(257, "h4", 20),
          o(258, "\u304A\u7533\u8FBC\u307F"),
          l(),
          a(259, "ul", 23)(260, "li"),
          o(
          ...
          l()()()(),
          a(279, "div", 16)(280, "h3", 17)(281, "div", 18),
          o(282, "STEP 02"),
          l()(),
          a(283, "div", 19)(284, "h4", 20),
          o(285, "\u5F53\u843D\u767A\u8868\u30FB\u5165\u91D1\u65B9\u6CD5"),
          l(),
          a(286, "ul", 23)(287, "li"),
          o(
          ...
          l()()()(),
          a(301, "div", 16)(302, "h3", 17)(303, "div", 18),
          o(304, "STEP 03"),
          l()(),
          a(305, "div", 19)(306, "h4", 20),
          o(307, "\u30C1\u30B1\u30C3\u30C8\u53D7\u53D6\u30FB\u5165\u5834\u65B9\u6CD5"),
          l(),
          a(308, "p"),
          o(
          ...
          l()()(),
          a(313, "div", 6)(314, "div", 7),
          o(315, "\u3010\u6CE8\u610F\u4E8B\u9805\u3011"),
          l(),
          a(316, "ul", 10)(317, "li", 9),
          o(
            318,
  ...
  (e.ɵfac = function (n) {
    ...
    (e.ɵcmp = j({
      ...
      consts: [
        ...
        [1, "signup"],
        [1, "signup-text"],
        ["tpl-button", "", "icon", "arrow-right", 1, "signup-button", 3, "click"],
        [1, "caution"],
        [1, "caution-title"],
        [1, "caution-content"],
        [1, "flow"],
        ...
        [1, "flow-content-item"],
        [1, "flow-content-item-title"],
        ["src", "./assets/guide/ticket/step01_01.png", "alt", "", 1, "flow-content-item-image"],
        ["src", "./assets/guide/ticket/step01_02.png", "alt", "", 1, "flow-content-item-image"],
        [1, "flow-content-item-note"],
        ["src", "./assets/guide/ticket/step01_03.png", "alt", "", 1, "flow-content-item-image"],
        ["src", "./assets/guide/ticket/step01_04.png", "alt", "", 1, "flow-content-item-image"],
        ["src", "./assets/guide/ticket/step01_05.png", "alt", "", 1, "flow-content-item-image"],
        ["src", "./assets/guide/ticket/step01_06.png", "alt", "", 1, "flow-content-item-image"],
        ["src", "./assets/guide/ticket/step01_07.png", "alt", "", 1, "flow-content-item-image"],
        ["src", "./assets/guide/ticket/step02_01.png", "alt", "", 1, "flow-content-item-image"],
        ["src", "./assets/guide/ticket/step02_02.png", "alt", "", 1, "flow-content-item-image"],
        ["src", "./assets/guide/ticket/step02_03.png", "alt", "", 1, "flow-content-item-image"],
        [1, "faq"],
        [1, "faq-item"],
        ["type", "checkbox", "id", "faq-01", 1, "faq-item-check"],
        ["for", "faq-01", 1, "faq-item-q"],
      ...
      template: function (n, r) {
        n & 1 &&
          (a(0, "section", 0)(1, "h2", 1),
          o(2, "\u30C1\u30B1\u30C3\u30C8\u5206\u914D\u30FB\u540C\u884C\u8005\u767B\u9332\u306E\u3054\u6848\u5185"),
          l(),
          a(3, "div", 2)(4, "div", 3),
          o(5, "\u30C1\u30B1\u30C3\u30C8\u5206\u914D\u30FB\u540C\u884C\u8005\u767B\u9332\u3068\u306F"),
          l(),
          ...
          o(
            7,
            " \u30C7\u30B8\u30BF\u30EB\u30C1\u30B1\u30C3\u30C8\u767A\u5238\u958B\u59CB\u5F8C\u3001\u4E00\u7DD2\u306B\u53C2\u52A0\u3055\u308C\u308B\u540C\u884C\u8005\u306B\u7533\u8FBC\u8005\u304C\u30C1\u30B1\u30C3\u30C8\u3092\u5206\u914D\u3057\u3066\u3044\u305F\u3060\u304F\u30B7\u30B9\u30C6\u30E0\u3067\u3059\u3002 "
          ),
          l()(),
          a(8, "div", 5)(9, "div", 6),
          o(
            10,
            "\u30C1\u30B1\u30C3\u30C8\u5206\u914D\u30FB\u540C\u884C\u8005\u767B\u9332\u306B\u306F\u3001\u540C\u884C\u8005\u3082\u4E8B\u524D\u306B\u30D0\u30F3\u30C0\u30A4\u30CA\u30E0\u30B3ID\u3078\u306E\u767B\u9332\u304C\u5FC5\u8981\u3067\u3059\u3002"
          ),
          l(),
          a(11, "a", 7),
          $("click", function () {
          ...
          o(
            19,
            " \u203B\u5165\u5834\u307E\u3067\u306B\u5FC5\u305A\u30C1\u30B1\u30C3\u30C8\u306E\u5206\u914D\u30FB\u540C\u884C\u8005\u767B\u9332\u3092\u884C\u3063\u3066\u304F\u3060\u3055\u3044\u3002\u540C\u884C\u8005\u767B\u9332\u304C\u5B8C\u4E86\u3057\u3066\u3044\u306A\u3044\u5834\u5408\u3001\u540C\u884C\u8005\u69D8\u306F\u5F53\u65E5\u3054\u5165\u5834\u3044\u305F\u3060\u3051\u307E\u305B\u3093\u3002 "
          ),
          p(20, "br"),
          o(
            21,
            " \u203B\u30EA\u30BB\u30FC\u30EB\u306E\u6709\u7121\u3001\u6761\u4EF6\u306F\u53D7\u4ED8\u306B\u3088\u3063\u3066\u7570\u306A\u308A\u307E\u3059\u306E\u3067\u3001\u5404\u53D7\u4ED8\u306B\u3066\u3054\u78BA\u8A8D\u306E\u3046\u3048\u304A\u7533\u8FBC\u307F\u304F\u3060\u3055\u3044\u3002 "
          ),
          p(22, "br"),
          o(
            23,
            " \u203B\u304A\u7533\u8FBC\u307F\u6642\u306B\u540C\u884C\u8005\u3092\u6307\u5B9A\u3057\u3066\u3044\u306A\u3044\u516C\u6F14\u306E\u307F\u304A\u624B\u7D9A\u304D\u304C\u5FC5\u8981\u3067\u3059\u3002\u304A\u7533\u8FBC\u307F\u6642\u306B\u540C\u884C\u8005\u767B\u9332\u6E08\u307F\u306E\u516C\u6F14\u306F\u304A\u624B\u7D9A\u304D\u3044\u305F\u3060\u3051\u307E\u305B\u3093\u3002 "
          ),
          l()()(),
          a(24, "section", 0)(25, "h2", 1),
          o(26, "\u30C1\u30B1\u30C3\u30C8\u5206\u914D\u30FB\u540C\u884C\u8005\u767B\u9332\u306E\u6D41\u308C"),
          l(),
          a(27, "div", 11)(28, "div", 12)(29, "div", 13)(30, "div", 14),
          o(31, "STEP 01"),
          l(),
          a(32, "div", 15),
          o(33, " \u540C\u884C\u8005\u306B\u30C1\u30B1\u30C3\u30C8\u3092\u5206\u914D\u3059\u308B "),
          ...
          o(
            49,
            " \u306A\u304A\u540C\u884C\u8005\u304C\u30C1\u30B1\u30C3\u30C8\u3092\u53D7\u3051\u53D6\u3063\u305F\u3042\u3068\u306F\u7533\u8FBC\u8005\u5074\u3067\u5206\u914D\u306E\u53D6\u308A\u6D88\u3057\u306F\u3067\u304D\u307E\u305B\u3093\u3002 "
          ),
          l(),
          a(50, "div", 18)(51, "div", 19),
          o(52, "\u7533\u8FBC\u8005\u306E\u64CD\u4F5C"),
          l(),
          a(53, "div", 20)(54, "div", 21),
          o(55, "\u30B5\u30A4\u30C8\u306E\u30E1\u30CB\u30E5\u30FC(\uFF1D)"),
          l(),
          p(56, "img", 22),
          l(),
          a(57, "div", 20)(58, "div", 21),
          o(59, "\u30DE\u30A4\u30DA\u30FC\u30B8"),
          l(),
          p(60, "img", 23),
          a(61, "p", 24),
          ...
          l()(),
          a(63, "div", 20)(64, "div", 21),
          o(65, "\u30C1\u30B1\u30C3\u30C8\u4E00\u89A7"),
          l(),
          p(66, "img", 25),
          l(),
          a(67, "div", 20)(68, "div", 21),
          o(69, "\u5206\u914D\u3059\u308B\u30C1\u30B1\u30C3\u30C8\u3092\u958B\u304F"),
          l(),
          p(70, "img", 26),
          a(71, "p", 24),
          o(
            72,
            "\u203B\u300C\u5206\u914D\u4E0D\u53EF\u300D\u3068\u8A18\u8F09\u3055\u308C\u3066\u3044\u308B\u30C1\u30B1\u30C3\u30C8\u306F\u5206\u914D\u3067\u304D\u307E\u305B\u3093\u3002"
          ),
          l()(),
          a(73, "div", 20)(74, "div", 21),
          o(75, "\u300C\u30C1\u30B1\u30C3\u30C8\u3092\u5206\u914D\u3059\u308B\u300D\u3092\u30BF\u30C3\u30D7"),
          l(),
          p(76, "img", 27),
          l(),
          a(77, "div", 20)(78, "div", 21),
          o(79, "\u300C\u5206\u914D\u3059\u308B\u300D\u3092\u30BF\u30C3\u30D7"),
          l(),
          p(80, "img", 28),
          l(),
          a(81, "div", 20)(82, "div", 21),
          o(
            83,
            "\u30C1\u30B1\u30C3\u30C8\u5206\u914DURL\u3092\u540C\u884C\u8005\u3078\u9001\u4FE1\u3057\u3066\u304F\u3060\u3055\u3044"
          ),
          l(),
          p(84, "img", 29),
          l()()(),
          a(85, "div", 12)(86, "div", 13)(87, "div", 14),
          o(88, "STEP 02"),
          l(),
          a(89, "div", 15),
          o(90, " \u7533\u8FBC\u8005\u304B\u3089\u30C1\u30B1\u30C3\u30C8\u3092\u53D7\u3051\u53D6\u308B "),
          ...
          o(103, " \u3092\u30BF\u30C3\u30D7\u3057\u3066\u304F\u3060\u3055\u3044\u3002 "),
          l(),
          a(104, "div", 18)(105, "div", 19),
          o(106, "\u540C\u884C\u8005\u306E\u64CD\u4F5C"),
          l(),
          a(107, "div", 20),
          p(108, "img", 30),
          l(),
          a(109, "div", 20)(110, "div", 21),
          o(111, "\u30C1\u30B1\u30C3\u30C8\u4E00\u89A7"),
          l(),
          p(112, "img", 31),
          l(),
          ...
          p(114, "img", 32),
          l()()()()(),
          a(115, "section", 0)(116, "h2", 1),
          o(117, "\u3088\u304F\u3042\u308B\u3054\u8CEA\u554F"),
          l(),
          a(118, "div", 33)(119, "div", 34),
          p(120, "input", 35),
          a(121, "label", 36)(122, "div", 37),
          o(
            123,
            " \u7533\u8FBC\u8005\u3068\u3057\u3066\u30C1\u30B1\u30C3\u30C8\u3092\u8CFC\u5165\u3057\u3066\u3044\u308B\u5834\u5408\u3001\u4ED6\u306E\u65B9\u304C\u7533\u8FBC\u307F\u3057\u305F\u30C1\u30B1\u30C3\u30C8\u306E\u540C\u884C\u8005\u3068\u3057\u3066\u767B\u9332\u3067\u304D\u307E\u3059\u304B\uFF1F "
          ),
          ...
          o(
            125,
            " \u307E\u305F\u540C\u884C\u8005\u3068\u3057\u3066\u767B\u9332\u3057\u3066\u3044\u308B\u5834\u5408\u3001\u5225\u306E\u65B9\u306E\u540C\u884C\u8005\u3068\u3057\u3066\u767B\u9332\u3067\u304D\u307E\u3059\u304B\uFF1F "
          ),
          l()(),
          a(126, "div", 38)(127, "div", 39),
          o(
            128,
            " \u3059\u3067\u306B\u516C\u6F14\u306E\u30C1\u30B1\u30C3\u30C8\u3092\u304A\u6301\u3061\u3067\u3042\u308C\u3070\u3001\u540C\u3058\u516C\u6F14\u306B\u540C\u884C\u8005\u3068\u3057\u3066\u767B\u9332\u3059\u308B\u3053\u3068\u306F\u3067\u304D\u307E\u305B\u3093\u3002 "
          ),
          ...
          a(129, "div", 34),
          p(130, "input", 40),
          a(131, "label", 41)(132, "div", 37),
          o(
            133,
            "\u540C\u884C\u8005\u767B\u9332\u304C\u3067\u304D\u3066\u3044\u308B\u304B\u78BA\u8A8D\u3057\u305F\u3044\u3067\u3059\u3002"
          ),
          l()(),
          a(134, "div", 38)(135, "div", 39)(136, "div", 42),
          o(
            137,
            " \u540C\u884C\u8005\u767B\u9332\uFF08\u30C1\u30B1\u30C3\u30C8\u5206\u914D\uFF09\u304C\u5B8C\u4E86\u3059\u308B\u3068\u3001\u540C\u884C\u8005\u306E\u30C1\u30B1\u30C3\u30C8\u4E00\u89A7\u306B\u30C1\u30B1\u30C3\u30C8\u304C\u8868\u793A\u3055\u308C\u307E\u3059\u3002 "
          ),
          p(138, "br"),
          o(
            139,
            " \u307E\u305F\u3001\u7533\u8FBC\u8005\u306E\u30C1\u30B1\u30C3\u30C8\u4E00\u89A7\u306B\u306F\u5206\u914D\u4E2D\u306E\u30C1\u30B1\u30C3\u30C8\u304C\u8868\u793A\u3055\u308C\u306A\u304F\u306A\u308A\u307E\u3059\u3002 "
          ),
          l()()()(),
          a(140, "div", 34),
          p(141, "input", 43),
          a(142, "label", 44)(143, "div", 37),
          o(
            144,
            " \u540C\u884C\u8005\u767B\u9332\u5F8C\u306B\u540C\u884C\u8005\u306E\u5909\u66F4\u306F\u3067\u304D\u307E\u3059\u304B\uFF1F\u307E\u305F\u3001\u540C\u884C\u8005\u3092\u5909\u66F4\u3057\u305F\u5F8C\u306B\u518D\u5EA6\u5909\u66F4\u3067\u304D\u307E\u3059\u304B\uFF1F "
          ),
          l()(),
          a(145, "div", 38)(146, "div", 39),
          o(
            147,
            " \u540C\u884C\u8005\u304B\u3089\u30C1\u30B1\u30C3\u30C8\u3092\u8FD4\u5374\u3057\u3066\u3082\u3089\u3063\u305F\u3042\u3068\u3001\u300C\u30C1\u30B1\u30C3\u30C8\u5206\u914D\u30FB\u540C\u884C\u8005\u767B\u9332\u306E\u6D41\u308C\u300D\u3068\u540C\u3058\u624B\u9806\u3067\u5225\u306E\u65B9\u306B\u5206\u914D\u30FB\u540C\u884C\u8005\u767B\u9332\u3092\u3057\u3066\u304F\u3060\u3055\u3044\u3002 "
          ),
          l()()(),
          a(148, "div", 34),
          p(149, "input", 45),
          a(150, "label", 46)(151, "div", 37),
          o(
            152,
            " \u540C\u884C\u8005\u2192\u30C1\u30B1\u30C3\u30C8\u306E\u53D7\u53D6\u753B\u9762\u3067\u8AA4\u3063\u3066\u300C\u30AD\u30E3\u30F3\u30BB\u30EB\u300D\u3057\u3066\u3057\u307E\u3044\u307E\u3057\u305F\u3002\u3069\u3046\u3057\u305F\u3089\u3044\u3044\u3067\u3059\u304B\uFF1F "
          ),
          l()(),
          a(153, "div", 38)(154, "div", 39),
          o(
            155,
            "\u518D\u5EA6\u3001\u30C1\u30B1\u30C3\u30C8\u5206\u914DURL\u304B\u3089\u30A2\u30AF\u30BB\u30B9\u3057\u30C1\u30B1\u30C3\u30C8\u3092\u53D7\u3051\u53D6\u3063\u3066\u304F\u3060\u3055\u3044\u3002"
          ),
          l()()(),
          a(156, "div", 34),
          p(157, "input", 47),
          a(158, "label", 48)(159, "div", 37),
          o(
            160,
            " \u7533\u8FBC\u8005\u2192\u540C\u884C\u8005\u304C\u767B\u9332\u5B8C\u4E86\u3059\u308B\u524D\u306B\u8AA4\u3063\u3066\u5206\u914D\u306E\u53D6\u308A\u6D88\u3057\u3092\u3057\u3066\u3057\u307E\u3044\u307E\u3057\u305F\u3002\u3069\u3046\u3057\u305F\u3089\u3044\u3044\u3067\u3059\u304B\uFF1F "
          ),
          p(161, "br"),
          o(
            162,
            " \u540C\u884C\u8005\u2192\u8AA4\u3063\u3066\u7533\u8FBC\u8005\u306B\u30C1\u30B1\u30C3\u30C8\u3092\u8FD4\u5374\u3057\u3066\u3057\u307E\u3044\u307E\u3057\u305F\u3002\u3069\u3046\u3057\u305F\u3089\u3044\u3044\u3067\u3059\u304B\uFF1F "
          ),
          l()(),
          a(163, "div", 38)(164, "div", 39)(165, "div", 42),
          o(
            166,
            " \u518D\u5EA6\u3001\u300C\u30C1\u30B1\u30C3\u30C8\u5206\u914D\u30FB\u540C\u884C\u8005\u767B\u9332\u306E\u6D41\u308C\u300D\u3068\u540C\u3058\u624B\u9806\u3067\u5206\u914D\u30FB\u540C\u884C\u8005\u767B\u9332\u3092\u884C\u3063\u3066\u304F\u3060\u3055\u3044\u3002 "
          ),
          l()()()()()());
      },
      dependencies: [ue],
      styles: [
        '[_nghost-%COMP%]{--background: #f7f7f9;display:block;margin-top:16px}.section[_ngcontent-%COMP%] + .section[_ngcontent-%COMP%]{margin-top:120px}.section-heading[_ngcontent-%COMP%]{font-size:2rem;font-weight:600;margin-bottom:32px;position:relative;text-align:center}.section-heading[_ngcontent-%COMP%]:after{background-color:var(--tpl-color-accent);content:"";display:block;height:5px;margin:8px auto 0;width:64px}@media screen and (max-width: 768px){.section-heading[_ngcontent-%COMP%]{font-size:1.9rem}.section-heading[_ngcontent-%COMP%]:after{width:40px}}.caution[_ngcontent-%COMP%]{border:2px solid var(--tpl-color-attention);margin-top:40px;padding:12px}.caution-title[_ngcontent-%COMP%]{color:var(--tpl-color-attention);font-size:1.7rem;font-weight:600;margin-bottom:8px}.caution-content[_ngcontent-%COMP%]{font-size:1.5rem;line-height:1.7}.signup[_ngcontent-%COMP%]{margin:32px auto 0;max-width:320px;text-align:center}.signup-text[_ngcontent-%COMP%]{color:var(--tpl-color-primary);font-size:1.5rem;font-weight:600;line-height:1.6;text-align:center}.signup-button[_ngcontent-%COMP%]{margin-top:12px}.flow-header[_ngcontent-%COMP%]{align-items:center;display:flex;justify-content:center}.flow-header-step[_ngcontent-%COMP%]{background-color:var(--background);border-radius:10px;box-shadow:0 3px 6px #00000026;cursor:pointer;padding:16px 24px}@media screen and (min-width: 768.01px){.flow-header-step[_ngcontent-%COMP%]{transition:opacity .2s ease-out}.flow-header-step[_ngcontent-%COMP%]:hover{opacity:.8}}@media screen and (max-width: 768px){.flow-header-step[_ngcontent-%COMP%]{padding:12px 16px}}.flow-header-step-index[_ngcontent-%COMP%]{color:var(--tpl-color-primary);font-family:var(--tpl-number-font-family);font-size:2.3rem;font-weight:700}@media screen and (max-width: 768px){.flow-header-step-index[_ngcontent-%COMP%]{font-size:1.7rem}}.flow-header-step-title[_ngcontent-%COMP%]{font-size:1.7rem;line-height:1.4;margin-top:4px}@media screen and (max-width: 768px){.flow-header-step-title[_ngcontent-%COMP%]{font-size:1.3rem}}.flow-header-step-arrow[_ngcontent-%COMP%]{display:block;height:auto;margin:0 24px;transform:rotate(-90deg);width:20px}@media screen and (max-width: 768px){.flow-header-step-arrow[_ngcontent-%COMP%]{margin:0 12px;width:16px}}.flow-content[_ngcontent-%COMP%] + .flow-content[_ngcontent-%COMP%]{margin-top:80px}.flow-content-heading[_ngcontent-%COMP%]{text-align:center}.flow-content-heading-index[_ngcontent-%COMP%]{color:var(--tpl-color-primary);font-family:var(--tpl-number-font-family);font-size:3.7rem;font-weight:700}@media screen and (max-width: 768px){.flow-content-heading-index[_ngcontent-%COMP%]{font-size:3rem}}.flow-content-heading-title[_ngcontent-%COMP%]{font-size:1.9rem;font-weight:600;line-height:1.4;margin-top:2px}@media screen and (max-width: 768px){.flow-content-heading-title[_ngcontent-%COMP%]{font-size:1.7rem}}.flow-content-text[_ngcontent-%COMP%]{font-size:1.5rem;line-height:1.75;margin:24px 0;text-align:center}.flow-content-text[_ngcontent-%COMP%]   em[_ngcontent-%COMP%]{color:var(--tpl-color-accent);font-style:normal;font-weight:600}@media screen and (max-width: 768px){.flow-content-text[_ngcontent-%COMP%]{font-size:1.4rem;margin:16px 0;text-align:left}}.flow-content-section[_ngcontent-%COMP%]{background-color:var(--background);border-radius:10px;margin:0 auto;max-width:400px;overflow:hidden;padding:32px 24px}.flow-content-section[_ngcontent-%COMP%] + .flow-content-section[_ngcontent-%COMP%]{margin-top:32px}@media screen and (max-width: 768px){.flow-content-section[_ngcontent-%COMP%]{max-width:100%;padding:24px 16px}}.flow-content-section-title[_ngcontent-%COMP%]{background-color:var(--tpl-color-primary);color:var(--tpl-color-primary-contrast);font-size:1.7rem;font-weight:600;margin:-32px -24px 24px;padding:16px 24px;text-align:center}@media screen and (max-width: 768px){.flow-content-section-title[_ngcontent-%COMP%]{font-size:1.5rem;margin:-24px -16px 24px;padding:12px 16px}}.flow-content-item[_ngcontent-%COMP%]{margin:0 auto;max-width:280px}.flow-content-item[_ngcontent-%COMP%] + .flow-content-item[_ngcontent-%COMP%]{margin-top:32px}.flow-content-item[_ngcontent-%COMP%] + .flow-content-item[_ngcontent-%COMP%]:before{background:url(/assets/guide/pre-companion/arrow.svg) center center/cover no-repeat;content:"";display:block;height:18px;margin:0 auto 32px;width:20px}@media screen and (max-width: 768px){.flow-content-item[_ngcontent-%COMP%]{max-width:100%}.flow-content-item[_ngcontent-%COMP%] + .flow-content-item[_ngcontent-%COMP%]{margin-top:24px}.flow-content-item[_ngcontent-%COMP%] + .flow-content-item[_ngcontent-%COMP%]:before{height:15px;margin-bottom:24px;width:16px}}.flow-content-item-title[_ngcontent-%COMP%]{font-size:1.4rem;font-weight:600;margin-bottom:10px}.flow-content-item-note[_ngcontent-%COMP%]{color:var(--tpl-color-text-light);font-size:1.4rem;margin-top:8px}.flow-content-item-image[_ngcontent-%COMP%]{border-radius:10px;box-shadow:0 3px 6px #00000026;display:block;height:auto;width:100%}.group[_ngcontent-%COMP%]{margin-top:32px}.group-title[_ngcontent-%COMP%]{color:var(--tpl-color-primary);font-weight:700;margin-bottom:16px}.faq-item[_ngcontent-%COMP%] + .faq-item[_ngcontent-%COMP%]{border-top:1px solid var(--tpl-color-border)}.faq-item-check[_ngcontent-%COMP%]{display:none}.faq-item-q[_ngcontent-%COMP%]{align-items:center;border-bottom:1px solid var(--app-color-gold);cursor:pointer;display:flex;font-size:1.7rem;letter-spacing:.025em;line-height:1.8;padding:20px 0}.faq-item-q[_ngcontent-%COMP%]:before{color:var(--tpl-color-primary);content:"Q.";font-family:var(--tpl-number-font-family);font-size:4.2rem;font-weight:400;line-height:1;margin-right:24px}.faq-item-q[_ngcontent-%COMP%]:after{border-bottom:2px solid var(--tpl-color-primary);border-right:2px solid var(--tpl-color-primary);content:"";flex-shrink:0;height:12px;margin-left:auto;transform:rotate(45deg);transition:transform .2s ease-out;width:12px}.faq-item-check[_ngcontent-%COMP%]:checked ~ .faq-item-q[_ngcontent-%COMP%]:after{transform:rotate(-135deg)}@media screen and (max-width: 768px){.faq-item-q[_ngcontent-%COMP%]{font-size:1.5rem;padding:12px 0}.faq-item-q[_ngcontent-%COMP%]:before{font-size:3.5rem;margin-right:16px}.faq-item-q[_ngcontent-%COMP%]:after{height:8px;width:8px}}.faq-item-q-inner[_ngcontent-%COMP%]{flex:1;margin-right:16px}.faq-item-a[_ngcontent-%COMP%]{max-height:0;overflow:hidden;transition:max-height .3s ease-out}.faq-item-check[_ngcontent-%COMP%]:checked ~ .faq-item-a[_ngcontent-%COMP%]{max-height:200px}.faq-item-check[_ngcontent-%COMP%]:checked ~ .faq-item-a[_ngcontent-%COMP%]   .faq-item-a-inner[_ngcontent-%COMP%]{opacity:1;transform:translateY(0)}@media screen and (max-width: 768px){.faq-item-check[_ngcontent-%COMP%]:checked ~ .faq-item-a[_ngcontent-%COMP%]{max-height:400px}}.faq-item-a-inner[_ngcontent-%COMP%]{align-items:flex-start;display:flex;flex:1;font-size:1.5rem;line-height:1.8;opacity:0;padding:10px 0 20px;transform:translateY(-10px);transition:opacity .3s ease-out,transform .3s ease-out}.faq-item-a-inner[_ngcontent-%COMP%]:before{color:var(--tpl-color-accent);content:"A.";font-family:var(--tpl-number-font-family);font-size:4.2rem;font-weight:400;line-height:1;margin-right:24px;margin-top:-8px}@media screen and (max-width: 768px){.faq-item-a-inner[_ngcontent-%COMP%]{font-size:1.4rem}.faq-item-a-inner[_ngcontent-%COMP%]:before{font-size:3.5rem;margin-right:16px}}.faq-item-a-note[_ngcontent-%COMP%]{color:var(--tpl-color-text-light);font-size:1.3rem;margin-top:12px}',
      ],
    }));
  let i = e;
  return i;
...
var _0 = [
    {
      path: "guide",
      children: [
        { path: "pre-companion", component: On },
        { path: "resale", component: Tn },
        { path: "ticket", component: kn },
      ],
    },
  ],
  qn = _0;
var Nn = [
    {
      ...
      canActivate: [st],
      children: [...zu, ...qn],
      providers: [{ provide: qe, useClass: Mn }],
    },
    { path: "preview", canActivate: [st, qu], loadChildren: () => import("./chunk-EMI2ZRBZ.js") },
    ...Ru,
  ],
  zn = S.name === "production" ? Nn : Vu.concat(Nn);
function x0(i, e) {
  if (i & 1) {
    let t = Te();
...
var Rn = (() => {
  let e = class e {
    constructor() {
      (this.assets = O(Nu)), (this.sessionService = O(bu)), (this.isSignedIn$ = this.sessionService.isSignedIn$);
    }
    signOut() {
  ...
  (e.ɵfac = function (n) {
    ...
    (e.ɵcmp = j({
      ...
      template: function (n, r) {
        n & 1 && (Gt(0, x0, 11, 0, "div", 0), Zt(1, "async")), n & 2 && Ht("ngIf", Jt(1, 1, r.isSignedIn$) === !0);
      },
      dependencies: [te, nu, iu, ue],
      styles: [
...
var In = { apiEndpoint: S.apiEndpoint, authProviderId: S.authProviderId, boothType: "single" },
  Ln = {
    privacyPolicyLink: "https://legal.bandainamcoent.co.jp/privacy/",
    termsLink: "https://shop.asobistore.jp/guide/rule",
    specCommTransLawLink: "https://shop.asobistore.jp/guide/commercial_transactions",
    relatedSiteLinks: [
      {
        type: "external",
        label: "\u30A2\u30AB\u30A6\u30F3\u30C8\u8A2D\u5B9A",
        href: `${S.groupSiteUrls.idp}/account.html?client_id=lalabit&backto=${encodeURIComponent(
          S.groupSiteUrls.ticket + "/mypage"
        )}`,
      },
      {
        type: "external",
        label: "\u4F4F\u6240\u5909\u66F4",
        href: `${S.groupSiteUrls.idp}/contact.html?client_id=lalabit&backto=${encodeURIComponent(
          S.groupSiteUrls.ticket + "/mypage"
        )}`,
      },
    ],
  };
var Kn = { common: { copyright: "&copy; copyright All Right Reserved." } };
var jn = { revision: "0ddd668", branch: "HEAD", triadVersion: "1.17.0", ticketVersion: "1.17.0" };
var Vn = {
    type: "ticket",
    environment: S.name,
    ...
    recaptchaCheckboxSiteKey: S.recaptchaCheckboxSiteKey,
  ...
  Un = {
    ...
    siteLinks: [
      { label: "ACCOUNT", href: S.groupSiteUrls.idp, theme: "accent", type: "external" },
      { label: "LIVE TICKET", href: "/", theme: "primary", type: "internal" },
      { label: "STORE", href: S.groupSiteUrls.store, theme: "store", type: "external" },
    ],
  };
uu(Ju);
var $n = {
  providers: [
    he(nt),
    { provide: eu, useValue: "ja-JP" },
    cu(zn, du(), mu({ scrollPositionRestoration: "enabled" })),
    Yu(Vn, Un, Kn),
    Iu(In, Ln),
    bn(),
    Tu({ promoteMemberRankModalBottom: Rn }),
    { provide: Lu, useValue: S.gtmContainerId },
    { provide: Ku, useValue: S.oneTrustDomainScript },
  ],
};
su(Zu, $n).catch((i) => console.error(i));
//# sourceMappingURL=main-YEBC27LY.js.map
