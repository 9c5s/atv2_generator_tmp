  ...
  var data = {
    resource: {
      ...
      tags: [
        ...
        },
        {
          ...
          priority: 10,
          vtp_instanceDestinationId: "G-496M962MBZ",
          tag_id: 120,
        },
        {
        ...
        },
        {
          ...
          vtp_conversionRules: [
            ...
            [
              "map",
              "matchingRules",
              '{"type":5,"args":[{"stringValue":"ecommerce_purchase"},{"contextValue":{"namespaceType":1,"keyParts":["eventName"]}}]}',
            ],
            [
              "map",
              "matchingRules",
      ...
      rules: [
        ...
        [
          ["if", 1],
          ["add", 0, 1, 14, 12, 11, 10, 9, 8, 7, 6, 5, 4, 3],
        ],
        [
          ["if", 2],
          ["add", 2],
    ...
    runtime: [
      ...
      [
        ...
        [
          22,
          [20, [17, [15, "a"], "delegationMode"], "ON"],
          [
            46,
            [
              53,
              [52, "d", ["require", "internal.isDmaRegion"]],
              [
                22,
                ["d"],
                [
                  46,
                  [53, [52, "e", ["require", "internal.setDelegatedConsentType"]], ["e", "ad_user_data", "ad_storage"]],
                ],
              ],
            ],
          ],
        ...
        [52, "c", [8]],
        [22, [20, [17, [15, "a"], "dmaDefault"], "GRANTED"], [46, [43, [15, "c"], "ad_user_data", "granted"]]],
        [22, [21, [16, [15, "c"], "ad_user_data"], [44]], [46, ["b", [15, "c"]]]],
        [2, [15, "a"], "gtmOnSuccess", [7]],
      ],
      [
        50,
...
*/
  ...
  ki.je = Number("0") || 0;
  ki.Ya = "dataLayer";
  ki.jn = "ChEI8KTbsgYQlsi8wsTat/v2ARIlAHTn/deI+Ug/ifos0kzPeTG3E7ubpB8otpz5uYZSeLPumrOuPxoCyj0\x3d";
  var mi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function qB(a) {
    ...
    for (var b = a.Zb(), c = b.length(), d = 0; d < c; d++) {
      var e = b.get(d);
      e !== Q.g.jc && N(this, "access_consent", e, "write");
    }
    var f = Jz(this),
      g = f.eventId,
      h = AA(f),
      m = Lx("consent", "declare", J(a));
    Px(m, g, h);
  }
  ...
  function AE() {
    ...
    N(this, "read_container_data"),
      W(35) && zE
        ? (a = zE)
        : (a.set("containerId", "G-496M962MBZ"),
          a.set("version", "7"),
  ...
  function xH(a, b) {
    K(this.getName(), ["requestedConsentType:!string", "delegatedConsentType:!string"], arguments),
      ...
      sl() && (Fl.delegatedConsentTypes[a] = b);
  }
